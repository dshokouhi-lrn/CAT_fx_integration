	...
	static public void editBinaryTemplate(String showTitle, String pageTitle, String binaryContent, String binaryChoice1, String binaryChoice2, String binaryDesktop, String binaryDesktopImageDesc, String binaryDesktopAltText, String binaryMobile, String binaryMobileImageDesc, String binaryMobileAltText, String pageAudio, String backgroundImage) throws Exception
	{
		try
		{
			...
			if (binaryDesktop != "")
			{
				...
				WebElement file = driver.findElement(By.xpath(".//*[@id='binaryListImage']/div/div[1]/input"));
			...
			if (binaryMobile != "")
			{
				...
				WebElement file = driver.findElement(By.xpath(".//*[@id='binaryListImage_mobileReady']/div/div[1]/input"));
				file.sendKeys("C:\\github\\CAT_fx_integration\\CAT_integration\\resource\\images\\" + image + ".jpg");
				//uploadFile("C:\\github\\CAT_fx_integration\\CAT_integration\\resource\\images\\" + image + ".jpg");
				Thread.sleep(15000);
